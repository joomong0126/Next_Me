    ...
    <Dialog open={open} onOpenChange={(nextState) => !nextState && onClose()}>
      <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
        ...
        <div className="space-y-4 py-4">
          ...
          <div>
            <label className="text-sm mb-2 block">기간 (직접 입력)</label>
            <Input value={formValues.period} onChange={(event) => handleChange('period', event.target.value)} placeholder="예: 2023.01 - 2023.06" />
          </div>
